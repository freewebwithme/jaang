defmodule JaangWeb.Components.SideNavigationComponent do
  ...
  def render(assigns) do
    IO.inspect(assigns, label: "INSPECTING ASSIGNS")
    ~H"""
      <div>
        ...
        <div class="md:pl-64">
          <div class="mx-auto flex w-full flex-col md:px-8 xl:px-4">
              ...
              <div class="flex flex-1 justify-between px-4 md:px-0">
                ...
                <div class="ml-4 flex items-center md:ml-6">
                  ...
                  <div class="relative ml-3">
                    <div>
                      <button type="button" class="flex max-w-xs items-center rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2" id="user-menu-button" aria-expanded="false" aria-haspopup="true">
