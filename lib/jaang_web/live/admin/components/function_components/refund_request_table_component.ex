defmodule JaangWeb.Admin.Components.FunctionComponents.RefundRequestTableComponent do
  ...
  def refund_request_table(assigns) do
    ~H"""
                  ...
                  <%= for request <- @refund_requests do %>
                    <tr id={"#{request.id}"}>
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900"><%= request.user.email %></div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
                        <div class="text-sm text-gray-900"><%= Enum.count(request.refund_items) %></div>
                      </td>
                      <td class="px-6 py-4 whitespace-nowrap">
