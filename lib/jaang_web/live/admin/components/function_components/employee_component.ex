        ...
        <li class="px-y py-4 border-b border-gray-200">
          <div class="flex items-center px-4 py-4 sm:px-6">
            ...
            <div class="flex items-center">
              ...
              <.link navigate={Routes.live_path(@socket, JaangWeb.Admin.Employees.EmployeeDetailLive, employee.id)}
                  class="text-sm text-indigo-600 hover:text-indigo-900">View</.link>
