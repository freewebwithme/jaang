defmodule Jaang.Account.UserToken do
  use Ecto.Schema
  import Ecto.Query
  ...
  def user_and_contexts_query(user, :all) do
    from t in Jaang.Account.UserToken, where: t.user_id == ^user.id
  end

  def user_and_contexts_query(user, [_ | _] = contexts) do
    from t in Jaang.Account.UserToken, where: t.user_id == ^user.id and t.context in ^contexts
  end
end
