defmodule Jaang.Admin.Account.AdminUserToken do
  use Ecto.Schema
  import Ecto.Query
  alias Jaang.Admin.Account.AdminUserToken
  ...
  schema "admin_users_tokens" do
    ...
    belongs_to :admin_user, Jaang.Admin.Account.AdminUser
  ...
  """
  def user_and_contexts_query(admin_user, :all) do
    from t in AdminUserToken, where: t.admin_user_id == ^admin_user.id
  end

  def user_and_contexts_query(admin_user, [_ | _] = contexts) do
