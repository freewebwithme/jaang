...
#    alias Jaang.Admin.CustomerService.CustomerMessage
#
...
#
#      assert {:ok, %CustomerMessage{} = customer_message} =
#               CustomerServices.create_customer_message(valid_attrs)
#
...
#               CustomerServices.create_customer_message(@invalid_attrs)
#    end
#
...
#
#      assert {:ok, %CustomerMessage{} = customer_message} =
#               CustomerServices.update_customer_message(customer_message, update_attrs)
#
...
#
#      assert {:error, %Ecto.Changeset{}} =
#               CustomerServices.update_customer_message(customer_message, @invalid_attrs)
#
...
#               CustomerServices.delete_customer_message(customer_message)
#
#      assert_raise Ecto.NoResultsError, fn ->
#        CustomerServices.get_customer_message!(customer_message.id)
#      end
#    end
#
